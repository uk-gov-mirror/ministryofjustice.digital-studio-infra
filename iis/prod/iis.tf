...
resource "azurerm_app_service" "app" {
  ...
  site_config {
    ...
    ip_restriction {
      ip_address = "157.203.177.192"
    }

    ip_restriction {
      ip_address = "62.25.109.201"
    }

    ip_restriction {
      ip_address = "62.25.109.203"
    }

    ip_restriction {
      ip_address = "212.137.36.233"
    }

    ip_restriction {
      ip_address = "212.137.36.234"
    }
