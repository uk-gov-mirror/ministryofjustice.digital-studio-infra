...
resource "azurerm_application_gateway" "o11y-app-gw" {
  ...
  ssl_certificate {
    ...
    data     = "${local.bootstrap_o11y_selfsigned_cert}"
...
#  value     = "${local.bootstrap_o11y_selfsigned_cert}"
