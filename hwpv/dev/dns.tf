...
variable "cnames" {
  ...
  default = [
    ...
    { "dev-nagios" = "ba34e1da-e6d6-4104-bf7b-e04b2f359042.cloudapp.net." },
    { "dev-kibana" = "ba34e1da-e6d6-4104-bf7b-e04b2f359042.cloudapp.net." },
    { "dev-graphite" = "ba34e1da-e6d6-4104-bf7b-e04b2f359042.cloudapp.net." },
    { "dev-grafana" = "ba34e1da-e6d6-4104-bf7b-e04b2f359042.cloudapp.net." },
    { "dev-seyren" = "ba34e1da-e6d6-4104-bf7b-e04b2f359042.cloudapp.net." },
    ...
    { "nagios" = "00b0444e-6f89-4290-8aa7-c8a48a799827.cloudapp.net." },
    { "kibana" = "00b0444e-6f89-4290-8aa7-c8a48a799827.cloudapp.net." },
    { "graphite" = "00b0444e-6f89-4290-8aa7-c8a48a799827.cloudapp.net." },
    { "grafana" = "00b0444e-6f89-4290-8aa7-c8a48a799827.cloudapp.net." },
    { "seyren" = "00b0444e-6f89-4290-8aa7-c8a48a799827.cloudapp.net." }
  ]
}
