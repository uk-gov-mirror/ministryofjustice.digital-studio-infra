...
# All VPCs are allocated the same 4 subnets: public_a, _b, and private_a, _b
# The two public and private subnets are spread across two availability zones to protect against single AZ failure.
# The VMs in these subnets access the outside world through the declared AWS gateways and a default route to them.
# The internal hosts of each subnet are NAT'd by gateways to the outside world
